setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/MessmerESC")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/MessmerESC/MessmerESC_data.rds')
